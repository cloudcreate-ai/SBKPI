...
基于上游仓库 **[SBTI-test](https://github.com/UnluckyNinja/SBTI-test)** 的思路与结构做的**变种站点**：人格测验 + **SBTI 人格图鉴**（`wiki.html`）+ **SBKPI 扑克图鉴**（`sbpki.html`）。内容以**调侃、玩梗、搞笑**为主，**请勿当真**，更不适合当作心理测评、职场评价或任何严肃决策依据。
